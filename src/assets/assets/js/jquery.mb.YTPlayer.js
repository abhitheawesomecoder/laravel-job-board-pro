...
var getYTPVideoID = function( url ) {
	...
	if( url.indexOf( "youtu.be" ) > 0 ) {
		videoID = url.substr( url.lastIndexOf( "https://devitems.com/" ) + 1, url.length );
